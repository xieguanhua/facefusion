...
from facefusion.uis.components import about, age_modifier_options, background_remover_options, deep_swapper_options, download, execution, execution_thread_count, expression_restorer_options, face_debugger_options, face_editor_options, face_enhancer_options, face_swapper_options, frame_colorizer_options, frame_enhancer_options, lip_syncer_options, processors, webcam, webcam_options, webcam_voice_changer_options
	...
	with gradio.Blocks() as layout:
		with gradio.Row():
			with gradio.Column(scale = 4):
				...
				with gradio.Blocks():
					webcam_voice_changer_options.render()
				with gradio.Blocks():
					processors.render()
				with gradio.Blocks():
...
def listen() -> None:
	...
	webcam_voice_changer_options.listen()
	webcam.listen()
